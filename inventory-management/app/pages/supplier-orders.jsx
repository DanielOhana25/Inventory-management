  ...
  return (
    ...
    <main className="flex-grow p-8">
      ...
      <div className="flex flex-row justify-between mb-4">
       <SearchBar onSearch={handleSearch} placeholder={"Rechercher un commande fournisseur..."} />
            ...
            <table className="min-w-full divide-y-200">
              <thead className="bg-customGreenSecondary">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">Qte d'articles</th>
                  ...
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">Data de reception</th>
